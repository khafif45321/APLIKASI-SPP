...
<head>
  ...
  <title>Admin Pembayaran SPP | Locg in</title>
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="template/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
</head>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Admin</b>Petugas</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sistem Informasi Pembayaran SPP MA NU 03 Sunan Katong Kaliwungu</p>
